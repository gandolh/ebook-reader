...
- [decisions.md](wiki/decisions.md) — Locked tech/design decisions (D1–D32) — the settled calls future briefs and reviews must not relitigate without an explicit revisit + log note.
